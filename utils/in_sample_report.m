...
fcast_plan  = exogenize(fcast_plan,'D4L_CPI_TAR',exorng);
fcast_plan  = endogenize(fcast_plan,'SHK_D4L_CPI_TAR',exorng);
...
dbsave(res, 'results/res.csv');
dbsave(res, 'results/res.mat');
dbsave(dbfcast, 'results/dbfcast.csv');
dbsave(s, 'results/s_insample.csv');
...
erep = etime+12; % end of reported range
